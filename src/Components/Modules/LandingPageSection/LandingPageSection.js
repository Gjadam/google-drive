...
export default function LandingPageSection({title, text, image, dir}) {
  return (
    <div className={`${dir === 'reverse' ? 'flex-row-reverse ' : 'flex-row'} row  d-flex justify-content-center align-items-center flex-wrap  mt-5 m-auto `} data-aos="fade-right" data-aos-duration="1500">
